...
MAIN_URL="https://github.com/mrdarkthbd/DTunnelProxyServerRelease/raw/main/main.sh"
PROXY_URL="https://github.com/mrdarkthbd/DTunnelProxyServerRelease/raw/main/build/$(uname -i)/proxy"
